...
class sentistrength:
    ...
    def main(self,sentence):
        ...
        # print self.sentences_text
         #ket=("classified_text":". ".join(self.sentences_score) "tweet_text":". ".join(self.sentences_text) "sentence_score":self.sentences_score"max_positive":self.sentences_max_pos"max_negative":self.sentences_max_neg"kelas":sentence_result)
        mas="".join(self.sentences_score)
        mas1="".join(self.sentences_text)
        mas3="sentence_score:"+str(self.sentences_score)
        mas4="max_positive:"+str(self.sentences_max_pos)
        mas5="max_negative:"+str(self.sentences_max_neg)
        mas6=""+str(sentence_result)
        
        print("classified_text:"+mas)
        masih="classified_text:"+mas
        print("tweet_text:"+mas1)
        masih2="tweet_text:"+mas1
        print(mas3)
        print(mas3)
        print(mas4)
        print(mas5)
